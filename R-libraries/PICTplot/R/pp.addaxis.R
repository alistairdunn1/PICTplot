...
#'
#' @description Adds an axis to a plot generated by PICT, allowing full freedom to format an axis and tick mark labels.
#' @param labels.type
#' @description Adds an axis with optional axis labels to a PICT plot
#' @param side side to add the axis
#' @param labels.type labels.type
#' @param cex cex
#' @param lty lty
#' @param mgp mgp
#' @param tcl tcl
#' @param minor.tcp minor.tcp
#' @param label.text label.text
#' @details Adds an axis to a pp() plot
#' @return Invisibly return axis locations of major ticks
#' @export
#'
"pp.addaxis" <-
